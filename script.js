...
const PLACEHOLDER_IMAGE = "img/placeholder.webp"; 
const IMAGE_LOAD_RANGE = 5; 
...
function setTheme(theme) {
  document.body.classList.remove('theme-default', 'theme-retro', 'theme-legacy', 'theme-minimal');
